...
export const FeedPreview = ({ excludeSlug, limit = 3 }: FeedPreviewProps) => {
  ...
  return (
    <>
      <div className='bg-muted md:bg-background  -mx-3  pt-12 pb-10 md:py-16 flex gap-5 items-center md:justify-center'>
        <div className='h-0.5 w-full bg-border md:hidden' />
        <h3 className='text-foreground font-medium text-xl md:text-2xl w-fit whitespace-nowrap text-center'>
          Weitere Einträge
        </h3>
        <div className='h-0.5 w-full bg-border md:hidden' />
      </div>
      <div className='w-full space-y-12 max-w-420 mx-auto relative '>
